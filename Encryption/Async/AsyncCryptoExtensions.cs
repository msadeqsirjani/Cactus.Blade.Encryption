...
namespace Cactus.Blade.Encryption.Async
{
    ...
    /// </summary>
    public static class AsyncCryptoExtensions
    {
        /// <summary>
        ...
        public static Task<byte[]> EncryptAsync(this IAsyncCrypto crypto, byte[] plainText, CancellationToken cancellationToken = default) =>
            crypto.EncryptAsync(plainText, null, cancellationToken);
        ...
        public static Task<byte[]> DecryptAsync(this IAsyncCrypto crypto, byte[] cipherText, CancellationToken cancellationToken = default) =>
            crypto.DecryptAsync(cipherText, null, cancellationToken);
