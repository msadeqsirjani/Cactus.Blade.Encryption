...
namespace Cactus.Blade.Encryption.Symmetric
{
    ...
    {
        private readonly NameCollection<Credential> _credentials;
        ...
        public InMemoryCredentialRepository(IEnumerable<Credential> credentials) =>
            _credentials = credentials?.ToNameCollection(c => c.Name) ?? throw new ArgumentNullException(nameof(credentials));
