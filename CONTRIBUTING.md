...
Pull requests are the best way to propose changes to the codebase (I use [Github Flow](https://guides.github.com/introduction/flow/index.html)). I actively Ilcome your pull requests:
...
## Report bugs using Github's [issues](https://github.com/mohammadsadeqsirjani/Cactus.Blade/issues)
